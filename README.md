...
![Aurora 平铺横滑大厅（设置里可切换的老布局）](docs/images/hall-flat.png)
...
| `e2e.py` | **84/84 通过**（含环形队列首尾相接、封面越远越小且带倾斜、焦点封面居中、手动匹配只列候选不自动采纳、点候选才应用、按坐标真点封面、拖动后单击仍能进入、设置页输入不穿透、分类工作区新建/命名/排序/删除、整理模式多选归类、主页作用域过滤与胶囊清除、状态徽标、浅色主题与配色切换） |
